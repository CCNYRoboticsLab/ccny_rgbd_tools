...
//    pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_;
     ...
     *
     */
    void estimatePose(const PointCloudT::Ptr& model_cloud, const cv::Mat& mono_img, cv::Mat& virtual_img); ///< Estimates pose from the input monocular image using PnP and returns the virtual image generated from the previous known position and point cloud model
